...
that gets a customer’s subtotal as input and gets the 
current day of the week from your computer’s operating system. 
...
"""MARCOS CHINGA CSE 111| PROGRAMMING WITH FUNCTIONS | DISCOUNT CALCULATOR"""
